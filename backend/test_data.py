...
fake_users = [
    {'fullname': 'user0', 'email': 'user0@gmail.com', 'password':'1234'},
    {'fullname': 'user1', 'email': 'user1@gmail.com', 'password':'1234'},
    {'fullname': 'user2', 'email': 'user2@gmail.com', 'password':'1234'},
]
...
def generate_users():
    ...
    for item in fake_users:
        user = User.query.filter_by(username=item['fullname']).first()
        if user:
            users.append(user)
            continue
        user = User()
